...
> This is a heavily modified Nowify updated to use Vue3 and Vite, it sheds
> Webpack and other dependencies, has all linters and prettifiers disabled (temporarily)
